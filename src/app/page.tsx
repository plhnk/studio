    ...
    <>
      ...
      >
        <div className="flex flex-col gap-16 my-32">
          ...
          <button className="group flex items-center justify-between w-full xl:w-1/2 text-neutral-800 hover:text-red-500">
        ...
        >
          Tell me more
          <Arrow className="rotate-90 absolute translate-x-[calc(50vw-2.5rem)] lg:relative lg:translate-x-6 group-hover:translate-y-2 group-hover:text-red-500 transition-all duration-200 ease-in-out" />
        </button>
      </section>
